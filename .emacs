...
(custom-set-variables
 ...
 '(bibtex-completion-bibliography (quote ("~/org/notes/index.bib")))
 '(bibtex-completion-library-path (quote ("~/org/notes/lib")))
 ...
 '(org-agenda-clockreport-parameter-plist (quote (:link t :maxlevel 2 :fileskip0 t)) nil nil "Customized with use-package org")
 '(org-agenda-files (quote ("~/org/")) nil nil "Customized with use-package org")
...
"))) t nil "Customized with use-package org")
 '(org-catch-invisible-edits (quote show-and-error) nil nil "Customized with use-package org")
 '(org-clock-persist (quote history) nil nil "Customized with use-package org")
 ...
 '(org-latex-default-packages-alist
   (quote
    (("AUTO" "inputenc" t
     ...
     ("" "capt-of" nil nil)
     ("" "hyperref" nil nil))))
 '(org-latex-listings (quote minted) nil nil "Customized with use-package org")
 '(org-latex-packages-alist (quote (("" "minted" nil) ("" "booktabs" nil))) nil nil "Customized with use-package org")
 ...
 '(org-preview-latex-default-process (quote dvisvgm) nil nil "Customized with use-package org")
 '(org-refile-allow-creating-parent-nodes (quote confirm) nil nil "Customized with use-package org")
 '(org-refile-targets (quote ((org-agenda-files :maxlevel . 3))) nil nil "Customized with use-package org")
 '(org-refile-use-outline-path t nil nil "Customized with use-package org")
 '(org-use-property-inheritance (quote ("NOWEB-REF")) nil nil "Customized with use-package org")
 '(package-archives
   (quote
