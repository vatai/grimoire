...
#+begin_src bash
  ...
  url="https://raw.githubusercontent.com/DinkDonk/kitty-icon/main"

  mkdir -p "$icons" "$applications"
  curl -fLo "$icons/kitty-dark.png" "$url/kitty-dark.png"
  curl -fLo "$icons/kitty-light.png" "$url/kitty-light.png"

  sed "s|^Icon=.*|Icon=$icons/kitty-light.png|" \
      /usr/share/applications/kitty.desktop > "$applications/kitty.desktop"
